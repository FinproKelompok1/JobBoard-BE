...
class TransactionRouter {
    ...
    initialiazeRoutes() {
        ...
        this.router.post("/", auth_1.requireAuth, this.transactionController.createTransaction);
        this.router.post("/payment", auth_1.requireAuth, this.transactionController.getTransactionToken);
