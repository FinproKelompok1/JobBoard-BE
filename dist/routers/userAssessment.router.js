...
class UserAssessmentRouter {
    ...
    initializeRoutes() {
        this.router.post("/", auth_middleware_1.requireAuth, this.userAssessmentController.createUserAssessment);
        ...
        this.router.get("/download/:username/:userAssessmentId", auth_middleware_1.requireAuth, this.userAssessmentController.downloadCertificate);
    }
    getRouter() {
        return this.router;
    }
