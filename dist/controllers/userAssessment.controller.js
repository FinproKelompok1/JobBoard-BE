    ...
    createUserAssessment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if ((userSubscription === null || userSubscription === void 0 ? void 0 : userSubscription.assessmentCount) >= 2)
                ...
                yield prisma_1.default.userSubscription.update({
                    where: {
                        userId_subscriptionId: {
                            userId: userId,
                            subscriptionId: userSubscription === null || userSubscription === void 0 ? void 0 : userSubscription.subscriptionId,
                        },
                    },
